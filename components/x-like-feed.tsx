...
type NavTab = 'intelligence' | 'monitor' | 'ideas' | 'calibration' | 'globe' | 'preferences'
...
const FAMILIES: Family[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { icon: Bell, title: 'Monitoring & radar', desc: 'Watch a subject and get alerted when its public footprint changes.', status: 'Live', tab: 'monitor', tag: 'radar' },
      ...
      <Card className="overflow-hidden">
        <div className="border-b border-border/60 bg-gradient-to-br from-primary/10 via-transparent to-transparent p-5">
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-2xl font-bold tracking-tight">Lambda</h1>
