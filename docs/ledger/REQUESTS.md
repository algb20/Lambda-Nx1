...
| R199 | 2026-08-20 | `publishing` | 2 | `open` | تفعيل النشر التلقائي لأهم الأحداث، وعدم كتابة «AI» أمام المنشور — ينشر وحده دون إكثار |
...
| R205 | 2026-08-20 | `deploy` | 2 | `open` | ملف الزيب «لا يفتح التطبيق» — الزيب **كود مصدر** لا تطبيق جاهز؛ يحتاج `npm install && npm run build`. يجب توضيح ذلك وإرفاق تعليمات |
| R206 | 2026-08-20 | `globe` | | `open` | **صفحة الكرة: كل إعدادات المستخدم تُحفظ** — حاليًا مجرد تبديل الصفحة يمحو اختياراته |
| R207 | 2026-08-20 | `globe` | | `open` | **لكل صنف/بوّابة مربّع خاص** أسفل الكرة: أهم وأحدث الأخبار + التاريخ بالضبط + المصدر + التحليل، وفيه تدفّق وتسلسل |
| R208 | 2026-08-20 | `globe` | | `open` | **٢ أو ٣ خيارات لحجم المربّعات**، وترتيبها، وتفعيل الصنف يُفعّل مربّعه مباشرة |
| R209 | 2026-08-20 | `design` | | `open` | **اختيار من ١ إلى ٥ بوّابات** يختارها المستخدم لتظهر في الصفحة الرئيسية |
| R210 | 2026-08-20 | `auth` | 3 | `open` | داخل متصفّح Pi: التسجيل بمعرّف Pi **دون بريد**؛ خارجه بالبريد + استعادة الحساب |
| R211 | 2026-08-20 | `data` | | `open` | تأكيد أن **التخزين والربط بقاعدة البيانات يعمل كليًا** |
...
| R214 | 2026-08-20 | `gateways` | | `open` | **بوّابة خاصة لأهم الأخبار والتصريحات** — الأهم والأكثر أثرًا، مع الأثر والتحليل |
