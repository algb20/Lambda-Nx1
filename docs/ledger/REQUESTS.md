...
**وبديلٌ كيليّ آخر لا يوجد:** جُرّبت أربعة من عنوان مركز بيانات في نفس
الأمسية — MyMemory (حصّة اليوم منتهية)، وثلاث نسخ Lingva (500)،
وLibreTranslate (HTML). هذا بنيويّ: تلك الأطراف صُنعت للمتصفّحات، ومنتجنا
يترجم على الخادم **عمدًا** (ذاكرة مشتركة، وإخفاء المزوّد، وألا يعرف طرفٌ ثالث
مَن يقرأ بالعربية).
