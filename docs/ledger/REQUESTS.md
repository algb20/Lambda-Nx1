...
| R225 | 2026-08-20 | `markets` | 1 | `open` | **البلوكشين والعملات الرقمية وكل البورصات والأسهم والعقارات وكل ما في الأسواق** — بشكل احترافي في المشروع |
| R226 | 2026-08-20 | `gateways` | 1 | `open` | أين **الفئات والبوّابات المفقودة** — أكملها كلّها |
| R227 | 2026-08-20 | `innovation` | 1 | `open` | أين **الابتكار** وأين **الحلول الجديدة** |
| R228 | 2026-08-20 | `media` | 1 | `open` | أين **ميزة البثوث** (البثّ الحيّ) |
