...
| R178 | 2026-08-20 | `security` | 3 | `open` | **قاعدة دائمة في كل مشاريعنا:** الأسرار والمفاتيح تُحفظ في مكان لا يصله أحد غير المالك — ولا المساعدون ولا أي مطوّر يُضاف للمستودع |
...
| R182 | 2026-08-20 | `gateways` | | `open` | بوّابة تُظهر **تصنيف** الشركات |
...
| R193 | 2026-08-20 | `design` | | `open` | **التاريخ:** «قبل ساعة» وهو خبر من أيام. ضع التاريخ الأصلي بتوقيت المنطقة، والنسبي حتى يوم واحد ثم التاريخ فقط |
| R194 | 2026-08-20 | `auth` | 2 | `open` | الدخول باسم مستخدم Pi فقط وتلقائيًا — لأن Pi عندها KYC حقيقي |
| R195 | 2026-08-20 | `auth` | 2 | `open` | خارج Pi: الدخول بالبريد + رسالة كود لإنشاء كلمة السر |
| R196 | 2026-08-20 | `auth` | 2 | `open` | اسم مستخدم يختاره المستخدم |
| R197 | 2026-08-20 | `auth` | | `open` | **الاسم الكامل** عند التسجيل، ويظهر للآخرين اسم المستخدم فقط + رمز **عين** يبدّل إظهار/إخفاء الاسم الحقيقي بكل ضغطة |
