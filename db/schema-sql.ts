...
ALTER TABLE "email_followers" ENABLE ROW LEVEL SECURITY;
...
ALTER TABLE "radar_findings" ENABLE ROW LEVEL SECURITY;

ALTER TABLE "calibration_claims" ENABLE ROW LEVEL SECURITY;
